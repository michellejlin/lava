...
echo Example1_file1.fastq
   ...
   /usr/local/miniconda/bin/bwa mem -t !{task.cpus} -M lava_ref.fasta Example1_file1.fastq | /usr/local/miniconda/bin/samtools view -Sb - > aln.bam
...
if [[ Example1_ref.fasta == "NO_FILE" ]]
 ...
 mv Example1_file1.fastq CONTROL.fastq
