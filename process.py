...
# Takes file path and reads file specified as a fasta, returns two lists one of fasta names and the other of genomes
...
# Same code from VAPiD, takes two alignments and generates number indexes for easy conversion
...
# Takes a location relative to a reference genome and transfers the position to a new 
# location based on number arrays generated by build_num_arrays()
